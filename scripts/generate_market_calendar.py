...
def main():
    ...
    for market_name, info in MARKETS.items():
        ...
        output["markets"][market_name] = {
            ...
            "label": info["label"],
            "regular_sessions": info["regular_sessions"],
